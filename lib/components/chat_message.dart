    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          ...
          bottomLeft: chat.role == 'model' ? Radius.zero : Radius.circular(15),
          bottomRight: chat.role == 'model' ? Radius.circular(15) : Radius.zero,
        ),
      ),
      child: Column(
          ...
          if (chat.role == 'user' && chat.status == 'failed')
            GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  if (!isRetrying)
                    Icon(Icons.refresh_rounded, color: Colors.red, size: 15),
                  Text(
